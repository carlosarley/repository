...
public class IngresarDatos extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>El cogigo ingresado es: " + cod + "</h1>");
            out.println("<h1>El nombre ingresado es: " + nomb + "</h1>");
            out.println("<h1>La referencia ingresada es: " + refer + "</h1>");
            out.println("<h1>El cargo ingresado es: " + car + "</h1>");
            out.println("<h1>La categoria ingresada es: " + cate + "</h1>");
            out.println("<h1>La descripcion  ingresada es: " + desc + "</h1>");
